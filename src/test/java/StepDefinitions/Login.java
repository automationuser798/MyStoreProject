...
import Configurations.HTMLReportGenerator;
import Configurations.TakeScreenShot;
//import MyStore.config.baseclass;
import Configurations.GeckoConfiguration;
...
public class Login {
	...
	public void BeforeEveryScenario(Scenario scenario) throws UnknownHostException {
		...
		if (Config.listofsuite == null) {
			...
			HTMLReportGenerator.TestSuiteStart(".\\Reports\\Reports.html" , "Amit");
		}
		HTMLReportGenerator.TestSuiteStart(".\\Reports\\Reports.html", "Amit");
